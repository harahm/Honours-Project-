"""
Django settings for hubcar project.
...
WSGI_APPLICATION = 'hubcar.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'hubcarapp.social_auth_pipeline.create_user_by_type',  # <--- set the path to the function
